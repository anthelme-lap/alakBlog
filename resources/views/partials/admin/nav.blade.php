    ...
    <div class="navbar-menu-wrapper flex-grow d-flex align-items-stretch">
      ...
      <ul class="navbar-nav navbar-nav-right">
        <li class="nav-item dropdown d-none d-lg-block">
          <div class="d-flex">
            <a class="nav-link btn btn-success create-new-button" id="createbuttonDropdown"  href="{{route('create.article')}}">+ Créer un article</a>
            <a class="nav-link btn btn-success create-new-button" id="createbuttonDropdown"  href="{{route('article')}}"> Voir Article</a>
          </div>
